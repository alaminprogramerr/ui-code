...
export const BookingNav = [
    {
        label: 'Manage Booking(s)',
        to: '#/tables/booking-table'
    }
];
...
export const CustomerNav = [
    {
        ...
        to: '#/tables/customer-table'
    }
];
export const CuttingNav = [
    {
        label: 'Manage Cutting(s)',
        to: '#/tables/cutting-table'
    }
];
...
export const WorkerNav = [
    {
        label: 'Manage Worker(s)',
        to: '#/tables/worker-table'
    },
    {
        label: 'Assign Worker(s)',
        to: '#/tables/assign-worker-table'
    }
];
