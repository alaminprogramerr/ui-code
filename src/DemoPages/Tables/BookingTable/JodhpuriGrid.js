...
class JodhpuriGrid extends React.Component {

  constructor(props) {
    super(props);
    this.measurment_category = "Jodhpuri"
    this.column_data = []
    ...
    this.state = {
      data:[{}] ,
      Jodhpuri_grid_items:this.column_data,
  ...
  render() {
    return (
      ...
      <br/><br/>
      <FormGroup row>
      <Label for="Jodhpuri_quantity" sm={2}>Jodhpuri Quantity</Label>
      <Col sm={2.5}>
