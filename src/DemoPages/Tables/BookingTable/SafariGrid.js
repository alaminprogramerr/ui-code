...
class SafariGrid extends React.Component {

  constructor(props) {
    super(props);
    this.measurment_category = "Safari"
    this.column_data = []
    ...
    this.state = {
      data:[{}] ,
      Safari_grid_items:this.column_data,
  ...
  render() {
    return (
      ...
      <br/><br/>
      <FormGroup row>
      <Label for="Safari_quantity" sm={2}>Safari Quantity</Label>
      <Col sm={2.5}>
          <Input type="text" name="Safari_quantity" id="Safari_quantity"
                 placeholder=""/>
      </Col>
      </FormGroup>
      <br/><br/>
