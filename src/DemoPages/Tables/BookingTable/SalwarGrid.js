...
class SalwarGrid extends React.Component {

  constructor(props) {
    super(props);
    this.measurment_category = "Salwar"
    this.column_data = []
    ...
    this.state = {
      data:[{}] ,
      Salwar_grid_items:this.column_data,
      reactTable : this.reactTable,
      react_table_data:[],
      measurement_data :[],
      item_details : {item_type:this.measurment_category,item_qty:0,item_status:"",total_cost:0}
    };
  }
  ...
  render() {
    return (
      ...
      <br/><br/>
      <FormGroup row>
      <Label for="Salwar_quantity" sm={2}>Salwar Quantity</Label>
      <Col sm={2.5}>
          <Input type="text" name="Salwar_quantity" id="Salwar_quantity"
                 placeholder=""/>
      </Col>
      </FormGroup>
      <br/><br/>
