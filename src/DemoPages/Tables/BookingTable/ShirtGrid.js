...
class ShirtGrid extends React.Component {
  ...
  constructor(props) {
    ...
    this.item_details = {item_type:this.measurment_category,item_qty:0,item_status:"Created",total_cost:0}
          ...
          <FormGroup tag="fieldset">
              <FormGroup check>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <Label check>
                        <Input type="checkbox" value={this.state.non_grid_data.KB} name="booking_Shirt_KB_group" checked={this.state.non_grid_data.s_KB_Value} onChange={this.handleKBCheckBoxChange} name="booking_Shirt_KB_group"/>{' '}
                         KB
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </Label>
                    <Label check>
                        <Input type="checkbox" value={this.state.non_grid_data.GB} name="booking_Shirt_GB_group" checked={this.state.non_grid_data.s_GB_Value} onChange={this.handleGBCheckBoxChange} name="booking_Shirt_GB_group"/>{' '}
                        GB
                    </Label>
